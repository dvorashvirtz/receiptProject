...
const { TEST_MONGO_SERVER, MONGO_RECEIPT_DB, MONGO_CUSTOMERS_COLLECTION } = process.env || "mongodb://127.0.0.1:27017";
...
describe('CREATE_NEW_CUSTOMER', () => {
    ...
    it('should throw error when customer is exist', async () => {
        try {
            ...
            {
                expect(error.message).toBe(`the name 'chanan' is not available`)
